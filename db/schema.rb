...
ActiveRecord::Schema[7.1].define(version: 2024_05_01_085614) do
  ...
  create_table "albums_tags", id: false, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.bigint "album_id"
    t.bigint "tag_id"
